...
class Path(Node):
    ...
    def motion(self):
        ...
        #0.2, 7.85 => 90, 0.2, 3.925 => 45
    
        # Drive 2 meter forward (assuming max speed is 0.2 m/s)
        self.move(0.0, -0.2, 5.235)

        self.move(0.2, 0.0, 8)

        self.move(0.0, 0.2, 5.5)
        ...
        self.move(0.0, 0.2, 2.7)

        self.move(0.2, 0.0, 6.5)

        self.move(0.0, 0.2, 3.9)

        self.move(0.2, 0.0, 6.5)

        self.move(0.0, 0.2, 4.25)

        self.move(0.2, 0.0, 12.5)

        self.move(0.0, 0.2, 5.25)

        self.move(0.2, 0.0, 6.5)
        
        self.move(0.0, 0.2, 11)

        self.move(0.2, 0.0, 19)
